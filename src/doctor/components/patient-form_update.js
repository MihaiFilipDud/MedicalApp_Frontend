...
class PatientForm_update extends React.Component {

    constructor(props) {
        super(props);
        this.toggleForm = this.toggleForm.bind(this);
        this.reloadHandler = this.props.reloadHandler;
        this.getPatient = this.props.getPatient;
        ...
        this.state = {
            ...
            formControls: {
                ...
                medicalRecord: {
                    value: this.getPatient.medicalRecord,
                    placeholder: 'Medical record',
                    valid: true,
                    touched: false,
                ...
                age: {
                    value: this.getPatient.age,
                    placeholder: 'Age...',
                    valid: true,
                    touched: false,
                },
                address: {
                    value: this.getPatient.address,
                    placeholder: 'Cluj, Zorilor, Str. Lalelelor 21...',
                    valid: true,
                    touched: false,
                },
                gender: {
                    value: this.getPatient.gender,
                    valid: true,
                    touched: false,
                },
                username: {
                    value: this.getPatient.account.username,
                    placeholder: 'username',
                    valid: true,
                    touched: false,
                },
                password: {
                    value: this.getPatient.account.password,
    ...
    registerPatient(person) {
        return API_USERS.updatePatient(person, (result, status, error) => {
            ...
            <div>
                ...
                <FormGroup id='gender'>
                    ...
                    <select name='gender' id='genderField'
                            ...
                            required
                            defaultValue={this.getPatient.gender}>
...
export default PatientForm_update;
